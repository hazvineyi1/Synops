...
// is embedded in. Many of its table names collide with tables owned by other
// apps in the shared Postgres, so it must never share that instance's public
// schema. Prefer COMPASS_DATABASE_URL; fall back to DATABASE_URL only for
