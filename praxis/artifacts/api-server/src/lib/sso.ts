 ...
 * A valid token only proves the issuer vouches for the email. This app still independently checks
 * that the email maps to a super_admin before establishing a session.
 */
