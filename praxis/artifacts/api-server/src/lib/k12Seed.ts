  ...
  // 1) SOFÍA · Grade 3 · Spanish-speaking English learner ─────────────────────
  {
    ...
    modules: [
      ...
      { title: "Vocabulario en contexto", outcome: "Unir palabras nuevas de tercer grado con su significado.",
        hook: "Palabras nuevas: veloz, enorme, frágil… ¿sabes qué significan?", minutes: 25, video: "https://www.youtube.com/watch?v=jWeVsB5n7qQ", game: "pair",
...
if(MODE==='find')renderFind();else if(MODE==='match')renderMatch();else if(MODE==='memory')renderMemory();else if(MODE==='puzzle')renderPuzzle();else if(MODE==='pair')renderPair();else if(MODE==='sort')renderSort();else if(MODE==='ladder')renderLadder();else renderChoice();</script>`;
}
