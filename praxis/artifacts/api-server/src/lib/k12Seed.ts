  ...
  // 1) SOFÍA · Grade 3 · Spanish-speaking English learner ─────────────────────
  {
    ...
    modules: [
      { title: "La idea principal", outcome: "Distinguir la idea principal de los detalles de un texto.",
        hook: "Un texto tiene UNA idea grande y muchos detalles pequeños. ¿Puedes separarlos?", minutes: 13, game: "sort",
      ...
      { title: "Vocabulario en contexto", outcome: "Unir palabras nuevas de tercer grado con su significado.",
        hook: "Palabras nuevas: veloz, enorme, frágil… ¿sabes qué significan?", minutes: 13, game: "pair",
      ...
      { title: "Pistas del contexto", outcome: "Usar las palabras cercanas para descubrir una palabra nueva.",
        hook: "Lees una palabra que nunca has visto. ¿Te rindes? ¡Claro que no!", minutes: 13, game: "choice",
...
const SECOND_COURSES: K12Course[] = [
  ...
  },
  {
    ...
    modules: [
      { title: "Grupos Iguales", outcome: "Puedo mostrar una multiplicación como grupos iguales de objetos.", video: "https://www.youtube.com/watch?v=nnBBmOaBn_s", hook: "¿Cómo puedes contar 3 cajas con 4 galletas cada una sin contar una por una?", minutes: 12, game: "choice",
      ...
      { title: "Problemas con Multiplicación", outcome: "Puedo resolver problemas de la vida real usando la multiplicación.", hook: "Si cada mesa tiene la misma cantidad de sillas, ¿cómo sabes cuántas sillas hay en total?", minutes: 12, game: "pair",
