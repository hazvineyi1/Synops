...
<style>:root{--indigo:#4F46E5;--amber:#F59E0B;--ink:#1f2430;--ok:#15803d;--no:#b91c1c}*{box-sizing:border-box}body{font-family:Inter,system-ui,sans-serif;color:var(--ink);margin:0;padding:18px;background:#FBF7EF;overflow-x:hidden}h2{margin:.2rem 0 .6rem;font-size:1.25rem}#stars{text-align:center;font-weight:800;font-size:1.3rem;margin:0 0 8px}#rt{text-align:center;font-weight:800;font-size:1.2rem;color:var(--indigo);margin:6px 0 12px;min-height:1.2em}.q{background:#fff;border:2px solid #f0e9da;border-radius:20px;padding:16px 18px;margin:0 0 16px;box-shadow:0 2px 8px rgba(0,0,0,.05)}.q.solved{border-color:var(--ok);background:#f6fbf7}.qt{font-weight:700;font-size:1.1rem;margin:0 0 12px}.qimg{display:block;width:170px;height:170px;object-fit:contain;border-radius:22px;margin:0 auto 12px;background:#eef0fb;padding:10px;filter:drop-shadow(0 5px 9px rgba(0,0,0,.18))}.opt{display:flex;align-items:center;gap:10px;width:100%;text-align:left;border:2px solid #e6e0d0;background:#fff;border-radius:14px;padding:14px 16px;margin:8px 0;font:inherit;font-size:1.1rem;font-weight:700;cursor:pointer;transition:.15s}.opt:hover{border-color:var(--indigo);transform:translateY(-1px)}.opt .mk{margin-left:auto;font-size:1.3rem}.opt.correct{border-color:var(--ok);background:#e9f7ee;animation:pop .5s}.opt.wrong{border-color:var(--no);background:#fdecec;animation:shake .4s}@keyframes pop{0%{transform:scale(1)}40%{transform:scale(1.08)}70%{transform:scale(.97)}100%{transform:scale(1)}}@keyframes shake{0%,100%{transform:translateX(0)}25%{transform:translateX(-7px)}75%{transform:translateX(7px)}}.mrow{display:flex;gap:18px;justify-content:center;align-items:flex-start}.mcol{display:flex;flex-direction:column;gap:12px}.mpic{border:3px solid #e6e0d0;background:#fff;border-radius:18px;padding:6px;cursor:pointer;transition:.15s}.mpic img{width:104px;height:104px;object-fit:contain;display:block;border-radius:12px;background:#eef0fb;padding:6px}.mpic.sel{border-color:var(--indigo);transform:scale(1.06)}.mpic.done{border-color:var(--ok);opacity:.5;pointer-events:none}.mword{display:flex;align-items:center;justify-content:center;border:3px solid #e6e0d0;background:#fff;border-radius:16px;padding:0 20px;height:118px;font:inherit;font-size:1.3rem;font-weight:800;cursor:pointer;min-width:120px;transition:.15s}.mword:hover{border-color:var(--indigo)}.mword.done{border-color:var(--ok);background:#e9f7ee;opacity:.6;pointer-events:none}.mword.wrong{animation:shake .4s;border-color:var(--no)}.bar{height:12px;background:#eee;border-radius:8px;overflow:hidden;margin:16px 0 8px}.fill{height:100%;width:0;background:linear-gradient(90deg,#F59E0B,#15803d);transition:.4s}.hint{color:#6b7280;font-size:1rem;text-align:center;font-weight:600}.done{display:none;text-align:center;font-weight:800;font-size:1.5rem;color:var(--ok);margin:14px 0}.float{position:fixed;pointer-events:none;font-size:1.9rem;z-index:9;animation:rise 1.4s ease-out forwards}@keyframes rise{0%{transform:translateY(0) scale(.5);opacity:0}20%{opacity:1}100%{transform:translateY(-150px) scale(1.25) rotate(18deg);opacity:0}}.confetti{position:fixed;top:-30px;font-size:1.8rem;animation:fall linear forwards;z-index:9;pointer-events:none}@keyframes fall{to{transform:translateY(110vh) rotate(360deg);opacity:.85}}</style>
<h2>${title}</h2><div id="stars">⭐ 0</div><div id="rt"></div><div id="quiz"></div><div id="match" style="display:none"><p class="hint" style="margin-bottom:12px">Tap a picture, then tap its word! 👇</p><div class="mrow"><div class="mcol" id="pcol"></div><div class="mcol" id="wcol"></div></div></div><div class="bar"><div class="fill" id="f"></div></div><p id="s" class="hint">Tap the right answer! 👆</p><div id="done" class="done"></div>
