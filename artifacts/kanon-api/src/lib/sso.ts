 ...
 * A valid token only proves the issuer vouches for the email. Kanon still independently checks
 * that the email maps to a global admin before establishing a session.
 */
