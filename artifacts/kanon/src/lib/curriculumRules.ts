...
//
// The actual rules engine now lives in the shared @workspace/kanon-curriculum-engine
// package, so the public demo and the Kanon API evaluate curricula with the same
...
import {
  ...
  type QaReport,
  type Severity,
} from "@workspace/kanon-curriculum-engine";
...
export * from "@workspace/kanon-curriculum-engine";
