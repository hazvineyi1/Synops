...
let surfaceDefault: "app" | "site" | "student" = "app";
...
export function initAnalytics(opts: InitOpts): void {
  ...
  // The initial page view fires from there as well to avoid duplicates.
...
export function identify(): void {
  // Logged-in identity is implicit on the server via session cookie.
  // Reserved for future server-side stitching.
  track("identified");
}
